...
from graph_encoders.gl2vec import GL2VWL
...
class GL2VWL_AKSVD:
    def __init__(self):
        self.implementation = "GL2VWL_AKSVD"
...
wl_ksvd = GL2VWL_AKSVD()
wl_ksvd.run(G_vocab_train, G_ML_train, G_test, y_ML_train, y_test)